import { QuickTaskPanel } from "@/lib/quickTask/feature";
		...
		<Layout>
			<div className="flex py-10 h-screen gap-8">
				...
				<div className="flex flex-col gap-4 grow px-4 divide-y divide-dotted divide-zinc-200 ">
					...
					<div className="h-1/2 rounded-lg py-2 font-bold">
						<QuickTaskPanel />
					</div>
					<div className="h-1/4 bg-zinc-100 p-6 rounded-lg pt-2">hello</div>
				</div>
			</div>
		</Layout>
	);
